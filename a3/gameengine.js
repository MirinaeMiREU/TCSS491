...
GameEngine.prototype.init = function (ctx, play, pause, step, load, save) {
...
GameEngine.prototype.setSquares = function(squares) {
	this.squares = [];
	for (var i = 0; i < 62; i++) {
		this.squares.push([]);
		for (var j = 0; j < 82; j++) {
...
GameEngine.prototype.startInput = function () {
	...
	this.load.addEventListener("click", function (e) {
		that.socket.emit('load', { studentname: "Peter Bae", statename: "save"});
    }, false);
...
GameEngine.prototype.saveGame = function() {
	this.socket.emit('save', { studentname: "Peter Bae", statename: "save", state: this.squares });
}
